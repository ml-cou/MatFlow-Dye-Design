  ...
  const handleDFTCalculation = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_APP_API_URL}/api/smiles-dft/`,
        {
          method: "POST",
          headers: {
      ...
      <div className="flex justify-end gap-3 mb-4">
        {loading ? (
          <Button
            ...
            className="!bg-red-500 !text-white !font-medium !px-4 !py-2 !text-sm hover:!bg-red-600"
          >
            CANCEL
          </Button>
        ) : (
        ...
        <div className="mb-4 p-8 bg-white rounded-lg border border-gray-300 shadow-lg">
          <div className="flex flex-col items-center justify-center">
            ...
            <Typography variant="body2" className="!text-gray-600 !text-center">
              Click <span className="!text-danger-btn !font-semibold">"CANCEL OPERATION"</span> to stop the calculation.
            </Typography>
          </div>
        </div>
      )}
      ...
      {results && (
        <div className="mt-6">
          ...
          {results.converted_data && results.converted_data.length > 0 && (
            <div className="mb-6">
              <Typography variant="subtitle1" className="!font-medium !mb-3 !text-gray-800" gutterBottom>
                ...
                rowData={results.converted_data}
                      ...
                      height="500px"
                        ...
                        customColumnOrder={[
                          ...
                          'sa_score',
                          'psi4_psi4_ok', 'psi4_E_hf', 'psi4_homo', 'psi4_lumo', 'psi4_gap', 'psi4_error'
                        ]}
                        downloadOptions={{
                          minimalColumns: ['id', 'smiles', 'sa_score', 'psi4_psi4_ok', 'psi4_E_hf', 'psi4_gap']
                        }}
                      />
                </div>
              )}
