    ...
    >
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center">
          ...
          <h3 className="text-2xl font-bold text-blue-800">Prediction Results</h3>
        </div>
        <div className="flex items-center">
          <input
            type="text"
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="bg-blue-50 rounded-lg p-4">
          ...
          <p className="text-3xl font-bold text-blue-800">{sortedResults.length}</p>
        </div>
      ...
      <div className="overflow-x-auto max-h-96 overflow-y-auto">
        <table className="w-full border-collapse">
          <thead className="sticky top-0 bg-white z-10">
            <tr>
              <th
                className="border p-3 bg-blue-50 text-blue-700 cursor-pointer hover:bg-blue-100"
