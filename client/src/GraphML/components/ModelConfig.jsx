      ...
      >
        <div className="flex items-center">
          <div className="bg-blue-50 p-2 rounded-lg mr-4">
            <Settings className={`w-5 h-5 text-blue-600 ${expanded ? 'animate-pulse' : ''}`} />
          </div>
            ...
            <div className="px-6 pb-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="space-y-2 group">
                ...
                <select
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg bg-white shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm hover:border-blue-300"
                >
              ...
              {config.architecture === 'gat' && (
                <div className="space-y-2 group">
                  ...
                  <input
                    ...
                    className="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm hover:border-blue-300"
                  />
                </div>
              )}
              ...
              <div className="col-span-1 md:col-span-2 lg:col-span-3 flex justify-end space-x-3 pt-4 mt-2">
                ...
                <button
                  onClick={() => setExpanded(false)}
                  className="px-4 py-2 bg-blue-600 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-blue-700 transition-colors shadow-sm"
                >
                  Apply Changes
                </button>
              </div>
